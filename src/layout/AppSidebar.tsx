...
const AppSidebar: React.FC = () => {
    ...
    const navItems: NavItem[] = [
        ...
        {
            icon: <PaymentCardIcon width={24} height={24} fill="currentColor" />,
        ...
        >
            <div className={`py-8 flex  ${!isExpanded && !isHovered ? 'lg:justify-center' : 'justify-start'}`}>
                <Link href="/">
                    {isExpanded || isHovered || isMobileOpen ? (
                        <>
                            <AppLogo size="md" color={themeContext.theme === 'light' ? 'black' : 'white'} />
                        </>
                    ) : (
                        <AppLogo size="md" color={themeContext.theme === 'light' ? 'black' : 'white'} withoutText />
                    )}
                </Link>
            </div>
                ...
                <nav className="mb-6">
                    <div className="flex flex-col gap-4">
                        <div>
                            ...
                            >
                                {isExpanded || isHovered || isMobileOpen ? 'Quản lí' : <HorizontaLDots />}
                            </h2>
